...
const MobileBar = ({ handleClick, showSideBar }) => {
  ...
  return (
    <>
      ...
      />
      <div
        className='fixed bg-dark text-white right-4 p-4 z-50 flex flex-col justify-center items-start rounded gap-2 duration-300 ease-linear transition transform top-16 animate-nav origin-top'
      >
        <Button
          value={<TfiClose />}
          style='self-end pb-3'
