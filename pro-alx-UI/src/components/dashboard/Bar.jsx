...
const Bar = () => {
  ...
  return (
    <header className=''>
      ...
      <div className='hidden w-fit top-0 bottom-0 left-0 md:px-2 lg:px-4 z-20 border-r h-full md:flex flex-col items-left dark:bg-bar bg-main text-dark pb-[5rem] xl:px-7 dark:text-body'>
