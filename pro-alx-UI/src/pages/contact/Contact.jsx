...
const Contact = () => {
	return (
		<div className='mt-20 p-3 flex flex-col pb-7 dark:bg-dark dark:text-gray-300'>
			...
			<div className='flex flex-col md:flex-row md:px-6 md:gap-8 md:items-center md:justify-center px-[2rem]'>
				<img
					src={img}
					alt='contact icon'
					aria-hidden
