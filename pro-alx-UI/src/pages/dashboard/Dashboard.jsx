...
const Dashboard = () => {
  ...
  // 			<div className='fixed transform left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-3/4 md:w-fit z-[20] bg-body rounded-xl p-[2rem]'>
      ...
      <div className='self-end mb-[3rem] md:px-[2rem] w-3/4 md:w-fit flex flex-col'>
        ...
        <form onSubmit={handleFormSubmit} className='self-end text-right'>
          <select
            ...
            className='md:px-5 rounded-md py-1 focus:outline-none shadow-ul outline-none self-end'
          >
